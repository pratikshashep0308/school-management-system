...
const MODULE_FILES = {
  ...
  'M11 General Ledger': ['services/ledger/gl.check.js', 'services/ledger/integration.check.js', 'services/ledger/posting.test.js'],
  ...
  'M15 Payroll Integration': ['services/ingest/payrollIngest.check.js', 'services/ingest/payrollMapping.test.js'],
  ...
  'M24 Integrations': ['services/ingest/feeIngest.check.js', 'services/ingest/expenseIngest.check.js', 'services/settlement/settlement.check.js'],
  ...
  INTG: ['services/ingest/feeIngest.check.js'],
